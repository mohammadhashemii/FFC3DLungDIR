...
DEFAULT_PIXEL_VALUE = -1024  # for CREATIS dataset: the pixel value when transformed pixel is outside of the image
...
if __name__ == '__main__':
    ...
    for c in case_list:
        for p in range(10):
            raw_img_address = creatis_dir + str(c) + '/' + str(p) + '0.mhd'
    ...
    for c in to_be_cropped_case_list:
        for p in range(10):
            ...
            resampled_img_address = creatis_dir + str(c) + '/' + str(p) + '0_R.mha'
